        ...
        <div className=" ">
            <div className="grid grid-cols-1 md:grid-cols-2 max-w-full items-center justify-center pt-14 md:pt-5">
                <div className="text-center md:text-left ">
                    ...
                    <p className="pb-7 text-gray-500">Explore thousands of job opportunities with all the information you need. Its your future. Come find it. Manage all your job application from start to finish.</p>
                    <Link to="/listedBooks">
